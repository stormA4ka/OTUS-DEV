# Generated by Django 5.1.4 on 2025-01-26 15:49
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                (
                    "platform_type",
                    models.CharField(max_length=100, verbose_name="Тип площадки"),
                ),
                (
                    "legal_entity",
                    models.CharField(max_length=100, verbose_name="Юрлицо"),
                ),
                (
                    "problem_description",
                    models.TextField(verbose_name="Краткое описание проблемы"),
                ),
                (
                    "problem_location",
                    models.CharField(max_length=200, verbose_name="Место проблемы"),
                ),
                (
                    "problem_type",
                    models.CharField(max_length=100, verbose_name="Тип проблемы"),
                ),
                (
                    "task_date",
